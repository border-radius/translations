...
Кайл Симпсон (автор, [«You don't know js JS»][dont-know-js]) написал захватывающую серию из трех постов под названием [«JS Objects: Inherited a Mess.»][js-inherited-mess]
