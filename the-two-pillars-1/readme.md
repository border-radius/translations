...
В JavaScript **фабричные методы** - это просто конструктор функции **минус** обязательный `new`, опасность загрязнения глобальной области видимости и неудобные ограниченя (имею ввиду раздражающую большую букву в начале названия класса).
